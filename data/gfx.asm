...
MenuDigitsIconsGFX:: INCBIN "gfx/misc/menu_digits_icons.2bpp"
...
MenuDigits2GFX:: INCBIN "gfx/misc/menu_digits2.2bpp"
BattleUIGFX_571a:: INCBIN "gfx/misc/battleuigfx_571a.2bpp"
SaveScreenLabelsGFX:: INCBIN "gfx/misc/stat_cash.2bpp"
	INCBIN "gfx/misc/stat_colon.2bpp"
	INCBIN "gfx/misc/stat_seen.2bpp"
	INCBIN "gfx/misc/stat_caught.2bpp"
	INCBIN "gfx/misc/stat_playtime.2bpp"
	INCBIN "gfx/misc/stat_num_crystals.2bpp"
SaveScreenColonGFX:: INCBIN "gfx/misc/save_screen_colon.2bpp"
StartMenuBGGFX:: INCBIN "gfx/misc/startmenubg.2bpp"
