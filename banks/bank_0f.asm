...
Script_00f_400a:
	scr_checkbit wEventFlags + 2, $06, Script_00f_4016
	db $66 ; TEMP
...
Script_00f_405b:
	scr_checkbit wEventFlags + 1, $05, Script_00f_4065
	scr_04 text_0f_57ad
	scr_end
...
Script_00f_406d:
	scr_checkbit wEventFlags + 1, $05, Script_00f_4095
...
Script_00f_40ce:
	scr_checkbit wEventFlags + 1, $06, Script_00f_40d8
	scr_04 text_0f_4691
	scr_end

Script_00f_40d8:
	scr_checkbit wEventFlags + 2, $03, Script_00f_40ef
	scr_04 text_0f_4691
	scr_emote $00, $01 ; TEMP
	scr_delay $03, $20 ; TEMP
...
Script_00f_40ef:
	...
	scr_checkbit wEventFlags + 3, $03, Script_00f_415c
	scr_1c $03 ; TEMP
	scr_1c $02 ; TEMP
...
Script_00f_41ff:
	...
	scr_spriteface $04, $02 ; TEMP
	scr_4e $04, Script_00f_59b1
	scr_1c $04 ; TEMP
	scr_setbit $daa2, $05 ; TEMP
	scr_end

Script_00f_421c:
	scr_checkbit wEventFlags + 2, $06, Script_00f_42af
	scr_spriteface $03, $03 ; TEMP
	scr_spriteface $04, $02 ; TEMP
	...
	scr_checkbit wEventFlags + 3, $03, Script_00f_42a3
	scr_text text_0f_4bc3
	scr_spriteface $03, $02 ; TEMP
	scr_spriteface $04, $02 ; TEMP
	scr_1a $04, $03, $00, $10 ; TEMP
	scr_4e $03, Script_00f_594f
	scr_1b $03 ; TEMP
	scr_4e $03, Script_00f_5980
	scr_1c $03 ; TEMP
	scr_spriteface $04, $03 ; TEMP
	scr_text text_0f_4bf0
	scr_spriteface $04, $02 ; TEMP
	scr_4e $04, Script_00f_5980
	scr_1c $04 ; TEMP
	scr_emote $00, $01 ; TEMP
	scr_delay $03, $20 ; TEMP
...
Script_00f_435f:
	scr_checkbit wEventFlags + 2, $07, Script_00f_436d
	scr_04 text_0f_4e54
...
Script_00f_4385:
	...
	scr_checkbit wEventFlags + 4, $01, Script_00f_4396
	scr_35 $00 ; TEMP
	scr_end
...
Script_00f_43b6:
	scr_face $01 ; TEMP
	scr_text text_0f_4efb
	scr_checkbit wEventFlags + 3, $03, Script_00f_43c3
	scr_37
	scr_end
...
Script_00f_43c4:
	scr_face $01 ; TEMP
	scr_text text_0f_4f13
	scr_checkbit wEventFlags + 3, $03, Script_00f_43d1
	scr_36
	scr_end
...
Script_00f_44d1:
	scr_checkbit wEventFlags + 3, $01, Script_00f_44db
	scr_04 text_0f_5299
	scr_end
...
Script_00f_44df:
	scr_checkbit wEventFlags + 3, $01, Script_00f_458e
	scr_spriteface $02, $00 ; TEMP
...
Script_00f_4592:
	...
	scr_spritewalk $01, $01 ; TEMP
	scr_spriteface $01, $01 ; TEMP
	scr_farjump Script_00f_4507
	scr_end

Script_00f_45af:
	scr_checkbit wEventFlags + 3, $01, Script_00f_45b9
...
Script_00f_45bd:
	...
	scr_checkbit wEventFlags + 3, $01, Script_00f_45c7
	scr_end

Script_00f_45c7:
	scr_63 $01, Script_00f_45cf
