...
LetterCutscene_Attrmap:
	ds $168 ; all palette 0

LetterCutscene_InitialTilemap:
INCBIN "gfx/tilemaps/lettercutscene_tilemap_initial.tilemap"
LetterCutscene_Tilemap0:
INCBIN "gfx/tilemaps/lettercutscene_tilemap0.tilemap"
LetterCutscene_Tilemap1:
INCBIN "gfx/tilemaps/lettercutscene_tilemap1.tilemap"
LetterCutscene_Tilemap2:
INCBIN "gfx/tilemaps/lettercutscene_tilemap2.tilemap"
LetterCutscene_Tilemap3:
INCBIN "gfx/tilemaps/lettercutscene_tilemap3.tilemap"

LetterCutscene_GFX:
INCBIN "gfx/misc/lettercutscene_gfx.2bpp"
